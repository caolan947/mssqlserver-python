...
from sql_service import controller
import sql_service
...
class TestController(unittest.TestCase):
    def setUp(self):
        ...
        self.fake_uuid = 'a12ef9eb-3738-41aa-9dda-f11a20d8e17c'
        ...
        self.handler = controller.SqlService(
            'delete', 
            {
    ...
    @patch('sql_service.controller')
    def test__init__1(self, mock_self):
        #mock_utils.return_value = self.fake_logger
        mock_self.upper.return_value = 'DELETE'
        mock_self.SqlService.return_value = Mock()



        actual_result = controller.SqlService(
            'delete', 
            {
                'table': self.fake_table_name,
        ...
        self.assertEqual(actual_result.statement_type, 'DELETE')
